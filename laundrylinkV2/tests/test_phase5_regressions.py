...
class Phase5RegressionTests(unittest.TestCase):
    ...
    def test_job_order_decrements_per_activation_and_completes_once(self):
        ...
        self.assertIsNone(first.json.get("stored_transaction_id"))
        ...
        self.assertIsNone(second.json.get("stored_transaction_id"))
        ...
        conn.close()
        self.assertEqual(int(tx_count or 0), 1)
    ...
    def test_day_receipt_totals_reconcile(self):
        ...
        self.assertEqual(report["total_sales"], 100)
    ...
    def test_admin_can_update_day_change_time_setting(self):
        ...
        self.assertEqual(get_resp.json.get("day_change_time"), "08:01")
