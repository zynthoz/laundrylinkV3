...
function getMachineCardHtml(m) {
  ...
  const machineIcon = m.type === 'washer' 
    ...
    : `<svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="12" cy="13" r="5"></circle><line x1="6" y1="7" x2="10" y2="7" stroke-linecap="round"></line><circle cx="16" cy="7" r="1" fill="currentColor"></circle></svg>`;
